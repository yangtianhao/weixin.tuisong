...
public class Pusher {
     ...
     * 测试号的appId和secret
     */
    private static String appId = "wxdc5f7c4a9fd1730c";
    private static String secret = "5089f2ba36746196c1adf3be1576f309";
    //模版id
    private static String templateId = "kWrXhjfqhK-dGWNujspVV-KG7PKbNdyJtNoTUODjYQc";
